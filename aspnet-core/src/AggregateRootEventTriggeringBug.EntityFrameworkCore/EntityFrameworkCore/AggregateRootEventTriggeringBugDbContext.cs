...
public class AggregateRootEventTriggeringBugDbContext :
    AbpDbContext<AggregateRootEventTriggeringBugDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    public AggregateRootEventTriggeringBugDbContext(DbContextOptions<AggregateRootEventTriggeringBugDbContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        {
            b.ToTable(AggregateRootEventTriggeringBugConsts.DbTablePrefix + "Skus",
                AggregateRootEventTriggeringBugConsts.DbSchema);
        ...
        //{
        //    b.ToTable(AggregateRootEventTriggeringBugConsts.DbTablePrefix + "YourEntities", AggregateRootEventTriggeringBugConsts.DbSchema);
