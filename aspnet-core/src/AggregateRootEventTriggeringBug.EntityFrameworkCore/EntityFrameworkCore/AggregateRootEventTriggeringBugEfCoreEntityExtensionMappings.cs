...
public static class AggregateRootEventTriggeringBugEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE AggregateRootEventTriggeringBugModuleExtensionConfigurator CLASS (in the Domain.Shared project)
