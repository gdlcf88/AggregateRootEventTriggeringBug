...
namespace AggregateRootEventTriggeringBug.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("AggregateRootEventTriggeringBug") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "AggregateRootEventTriggeringBug", DisplayName = "AggregateRootEventTriggeringBug API", Resources = { "AggregateRootEventTriggeringBug" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        var commonScopes = new List<string> {
            ...
            "AggregateRootEventTriggeringBug"
        };
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["AggregateRootEventTriggeringBug_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["AggregateRootEventTriggeringBug_Swagger:RootUrl"]?.TrimEnd('/');
